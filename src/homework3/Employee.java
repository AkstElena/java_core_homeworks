...
//    }
    ...
    */
    public int comparator(int day, int month, int year) {
        return (birthDay + (birthMonth << 6) + (birthYear << 11)) - (day + (month << 6) + (year << 11));
// вернет меньше 0, если дата рождения раньше указанной даты
